...
function AboutUs() {
    ...
    <div className='w-full h-screen relative mt-14 '>
      ...
      <div className="grid gap-14 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 p-3 sm:p-6 place-items-center ">
        ...
        <div className='ml-40 mr-40'>
         ...
         <div className='ml-40 mr-40'>
         <h1 className='text-4xl font-bold text-center mt-16 mb-8'>Business Model</h1>
         <p className='text-xl font-sans font-normal leading-loose tracking-normal text-justify'>Our current business model is based on a decentralised approach, in which we will manufacture a mobile unit to convert agro waste into high gcv bio briquettes for use in furnaces and boilers for combustion.</p>
         <h2 className='text-2xl font-sans mt-2 mb-2 font-semibold tracking-normal'>Our revenue is generated through three channels:</h2>
          <ul className='text-xl font-sans font-normal leading-loose tracking-normal text-justify list-disc ml-6 list-inside'>
          ...
          <p className='text-xl font-sans font-normal leading-loose tracking-normal text-justify'>Our major savings will be in logistics of raw materials, facility space, space to hoard raw materials, space for finished goods and many more. This money saved will be directly reflected in our profit margin.</p>
         <h2 className='text-2xl font-sans mt-2 mb-2 font-semibold tracking-normal'>How is the need currently addressed:</h2>
         ...
         <h2 className='text-2xl font-sans mt-2 mb-2 font-semibold tracking-normal'>Primary Benefits:</h2>
         ...
         <div className='ml-40 mr-40'>
         <h1 className='text-4xl font-bold text-center mt-16 mb-8'>Customer Persona</h1>
         ...
         <div className='ml-40 mr-40'>
         <h1 className='text-4xl font-bold text-center mt-16 mb-8'>Value Proposition</h1>
         ...
         <div className='ml-40 mr-40'>
         <h1 className='text-4xl font-bold text-center mt-16 mb-8'>Market Capacity</h1>
         ...
         <p className='text-xl font-sans font-normal leading-loose tracking-normal text-justify'>
        (Ref: <a className="hover:text-blue-700 hover:underline" href="https://www.renewableenergymagazine.com/shannon-flynn/reports-show-huge-growth-potential-for-green-20220517" >https://www.renewableenergymagazine.com/shannon-flynn/reports-show-huge-growth-potential-for-green-20220517</a>).The rapid increase in public and investor awareness, coupled with the emergence of policies driving decarbonization, organizations have begun adopting and promoting environmental, social, and governance (ESG) measures.(Ref: <a className="hover:text-blue-700 hover:underline" href="https://www.mckinsey.com/business-functions/sustainability/our-insights/building-a-green-business-lessons-from-sustainability-start-ups" >https://www.mckinsey.com/business-functions/sustainability/our-insights/building-a-green-business-lessons-from-sustainability-start-ups</a>).</p>
         ...
         <div className='ml-40 mr-40'>
         <h1 className='text-4xl font-bold text-center mt-16 mb-8'>What motivated us :</h1>
      ...
      <div className='ml-40 mr-40 '>
      <h3 className='text-xl mb-2 mt-24 font-normal text-center tracking-normal'>PROFESSIONAL PEOPLE</h3>
      <h1 className='text-4xl font-bold text-center mt-4 mb-8'>Meet Our Team</h1>
      <div className='grid md:grid-cols-4 sm:grid-cols-2 gap-4 place-items-center'>
      <figure>
      <img src={per1} className='w-64'/>
      <figcaption className='text-xl mb-4 mt-2 font-normal text-center tracking-normal'>CEO & FOUNDER HBPL<br/>Krunal Jagtap</figcaption>
      </figure>
      <figure>
      <img src={per2} className='w-64'/>
      <figcaption className='text-xl mb-4 mt-2 font-normal text-center tracking-normal'>AI & IOT <br/>Harshada Kamble</figcaption>
      </figure>
      <figure>
      <img src={per3} className='w-64' />
      <figcaption className='text-xl mb-4 mt-2 font-normal text-center tracking-normal'>DIRECTOR & CRM <br/>Sheetal Jagtap</figcaption>
      </figure>
      <figure>
      <img src={per4} className='w-64' />
      <figcaption className='text-xl mb-4 mt-2 font-normal text-center tracking-normal'>MICROBIOLOGIST <br/>Dr. Shibani Sukhi</figcaption>
      </figure>
      </div>
      </div>
  ...
  <div className="relative">
    ...
    <h1 class="text-black text-4xl font-bold ">We’re Leader in Agriculture Market</h1>
    <button className="bg-[#199747] hover:bg-green-700 text-green-900 font-semibold hover:text-white py-4 px-8 border border-green-700 hover:border-transparent rounded w-50 h-50 text-xl">Shop Now</button>
    </div>
  </div>
